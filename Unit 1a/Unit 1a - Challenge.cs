...
public class CastleBuilding
{
	public static void Main()
	{
		...
		// List build options
		Console.WriteLine(border);  																											// Add a border space
		Console.WriteLine("1 = " + build1 + "     - Increases stone and wood gained from building a " + build2 + " or " + build3 + " by 20%."); // Write bulid1 and its conditions to console.
		Console.WriteLine("2 = " + build2 + " - Gain " + woodInc + " wood.");          															// Write bulid2 and its conditions to console.
		Console.WriteLine("3 = " + build3 + "   - Gain " + stoneInc + " stone.");      															// Write bulid3 and its conditions to console.
		Console.WriteLine("4 = " + build4 + "      - Cost: 200 wood and 300 stone.");  															// Write bulid4 and its conditions to console.
		Console.WriteLine(border); 																												// Add a border space	
